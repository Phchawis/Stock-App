...
export function DetailDrawer({ v }) {
  ...
  return detailOpen ? (<>
    ...
    <div className="ov-in" onClick={closeDetail} style={css(`position:fixed; inset:0; background:rgba(24,27,42,.42); z-index:40; display:flex; justify-content:flex-end;`)}>
      <div className="dr-in theme-content-teal" onClick={stop} style={css(`width:min(480px,94vw); height:100vh; background:#04303C; box-shadow:var(--shadow-lg); display:flex; flex-direction:column; overflow:hidden;`)}>
