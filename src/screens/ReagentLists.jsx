                              ...
                              <div style={css(`flex:1; min-width:0;`)}>
                                ...
                                <div style={css(`font:var(--text-3xs)/1.3 var(--font-body); color:var(--text-tertiary); margin-top:6px; display:flex; align-items:center; gap:6px 8px; flex-wrap:wrap;`)}>
                                  ...
                                  <button
                                    ...
                                    style={css(`background:var(--slate-50); border:1px solid var(--border-default); border-radius:var(--radius-sm); padding:2px 6px; font:var(--text-3xs)/1.2 var(--font-body); color:var(--text-secondary); cursor:pointer; display:inline-flex; align-items:center; gap:3px; transition:all var(--dur-fast); white-space:nowrap; flex-shrink:0;`)}
