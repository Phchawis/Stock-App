...
export function ReagentLists({ v }) {
  ...
  const getCategoryLabel = (c) => ({ CHE: 'หมวดงานศูนย์ปฏิบัติการตรวจวินิจฉัยทางการแพทย์', HEM: 'โลหิตวิทยา', IMM: 'ภูมิคุ้มกันวิทยา', MIP: 'จุลทรรศนศาสตร์', MDC: 'หมวดงานศูนย์ปฏิบัติการตรวจวินิจฉัยทางการแพทย์', HMS: 'หมวดบริการศูนย์การแพทย์', ADV: 'หมวดตรวจวินิจฉัยชั้นสูง' })[c] || c;
